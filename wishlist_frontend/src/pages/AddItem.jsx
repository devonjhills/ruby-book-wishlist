...
const AddItem = () => {
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2 space-y-6">
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-foreground warm-glow">
                  Book Information
                </h3>
                  ...
                  <div className="flex items-center gap-4">
                    {book.average_rating && (
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-foreground">
                          {book.average_rating.toFixed(1)} stars
                        </span>
                      </div>
                    )}
                    {book.rating_count && (
                  ...
                  <div className="flex flex-wrap gap-2">
                    {book.subjects.split(", ").map((subject, index) => (
                      <Badge
                        key={index}
                        variant="outline"
                        className="bg-muted/20 border-primary/30 text-xs"
                      >
  ...
  const handleManualSubmit = async (e) => {
    ...
    const itemData = {
      ...manualForm,
      item_type: itemType,
      release_year: manualForm.release_year
        ? parseInt(manualForm.release_year)
        : null,
    };
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 gap-4">
                  {searchResults.map((result, index) => (
                    <Card
                      key={index}
                      className="aged-paper border-border book-hover transition-all duration-300"
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setManualForm({
                      ...manualForm,
                      author_or_director: e.target.value,
                    })
                  }
                  className="input"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setManualForm({ ...manualForm, genre: e.target.value })
                  }
                  className="input"
